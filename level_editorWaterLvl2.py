...
#load images
sun_img = pygame.image.load('Images8/sun.png')
sun_img = pygame.transform.scale(sun_img, (tile_size, tile_size))
bg_img = pygame.image.load('Images8/bg.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('Images8/dirt.png')
grass_img = pygame.image.load('Images8/grass.png')
waterblock_img = pygame.image.load('Images8/waterblock.png')
waterwave_img = pygame.image.load('Images8/waterwave.png')
platform_x_img = pygame.image.load('Images8/platform.png')
platform_y_img = pygame.image.load('Images8/platform.png')
lava_img = pygame.image.load('Images8/lava.png')
spikesR_img = pygame.image.load('Images8/spikes_right.png')
spikesL_img = pygame.image.load('Images8/spikes_left.png')
water_img = pygame.image.load('Images8/water.png')
coin_img = pygame.image.load('Images8/coin.png')
exit_img = pygame.image.load('Images8/tiles_door.png')
key_img = pygame.image.load('Images8/tiles_oldkey.png')
save_img = pygame.image.load('Images8/save_btn.png')
load_img = pygame.image.load('Images8/load_btn.png')
