...
dirt_img = pygame.image.load('Images1/forrest_dirt_block.png')
dirt_l_img = pygame.image.load('Images1/forrest_dirt_block_l.png')
dirt_r_img = pygame.image.load('Images1/forrest_dirt_block_r.png')
dirt_bl_img = pygame.image.load('Images1/forrest_dirt_block_bl.png')
dirt_br_img = pygame.image.load('Images1/forrest_dirt_block_br.png')
dirt_top_img = pygame.image.load('Images1/forrest_dirt_block_top.png')
grass_img = pygame.image.load('Images1/forrest_grass.png')
grass_r_img = pygame.image.load('Images1/forrest_grass_r.png')
grass_l_img = pygame.image.load('Images1/forrest_grass_l.png')
platform_l_img = pygame.image.load('Images1/forrest_dirt_block.png')
platform_mid_img = pygame.image.load('Images1/forrest_dirt_block.png')
platform_r_img = pygame.image.load('Images1/forrest_dirt_block.png')
platform_img = pygame.image.load('Images1/forrest_dirt_block.png')
wall_bottom_img = pygame.image.load('Images1/forrest_dirt_block.png')
wall_mid_img = pygame.image.load('Images1/forrest_dirt_block.png')
wall_top_img = pygame.image.load('Images1/forrest_dirt_block.png')
waterblock_img = pygame.image.load('Images1/waterblock.png')
waterwave_img = pygame.image.load('Images3/waterwave.png')
platform_x_img = pygame.image.load('Images1/forrest_moving_platform.png')
platform_y_img = pygame.image.load('Images1/forrest_moving_platform.png')
...
coin_img = pygame.image.load('Images1/coin.png')
		...
		for col in range(40):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 4:
					#dirt blocks bottom left
					img = pygame.transform.scale(dirt_bl_img, (tile_size, tile_size))
					screen.blit(img, (col * tile_size, row * tile_size))
				if world_data[row][col] == 5:
					#dirt blocks bottom right
					img = pygame.transform.scale(dirt_br_img, (tile_size, tile_size))
					screen.blit(img, (col * tile_size, row * tile_size))
				if world_data[row][col] == 6:
					#dirt blocks top
					img = pygame.transform.scale(dirt_top_img, (tile_size, tile_size))
					screen.blit(img, (col * tile_size, row * tile_size))
